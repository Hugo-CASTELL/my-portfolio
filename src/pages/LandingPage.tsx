...
export default function LandingPage() {
  ...
  pinnedContent.forEach(
    (_, i) => (pinnedContent[i] = gradients[i % gradients.length]),
  )
  ...
  return (
    <div className="relative flex flex-col h-full">
      <div
        className={
          "grow flex flex-col items-center justify-center w-full uppercase text-center font-extrabold tracking-tighter"
        }
      >
        <h1 className="text-(length:--title-size) tracking-normal inline-flex items-center gap-8">
          Hello I am
          <div className={"rounded-lg bg-primary text-background p-3"}>
            Hugo Castell
          </div>
          this is my
        </h1>
        <div className={"flex justify-between w-full"}>
          ...
          <div className={"relative px-8"}>
            ...
            <div className={"scale-y-180 origin-center translate-y-3.5"}>
              <h1 className={"text-(length:--very-big-title-size)"}>
                Portfolio
              </h1>
            </div>
          </div>
      ...
      <div
        className={
          "h-1/3 grid grid-cols-[repeat(auto-fit,minmax(12rem,1fr))] items-center justify-items-center"
        }
      >
